// =========================================================
// ANCHOR PLATE V4 — Hex String Tie-Off Plate + M4 Bolt Flange
// =========================================================
// Sits on TOP of the main stack (above Tier 1).
// All strings are anchored here — one hole per column position.
// Same hex shape as matrix tiers (HEX_R from config_v4) with 6
// post notches at vertices for frame rod clearance.
//
// All geometry parameters sourced from config_v4.scad.
// Staggered column positions via col_x(count, idx, ch_idx).
//
// Features:
//   - Regular hex plate (HEX_R), ANCHOR_THICK thick
