// =========================================================
// GUIDE PLATE V4 -- Hex Dampener Plates (Frame-Clamped)
// =========================================================
...
//
// V4 changes:
//   - All geometry params from config_v4.scad (single source of truth)
//   - Staggered col_x(count, idx, ch_idx) for all column placements
// =========================================================
...
// =============================================
// LOCAL PARAMETERS (not in config)
// =============================================
...
// =========================================================
module guide_plate_assembly_v4() {
...
// =========================================================
module ptfe_bushing_v4(plate_thick = 3.0) {
    color(C_BUSHING)
    difference() {
        union() {
            // Body
