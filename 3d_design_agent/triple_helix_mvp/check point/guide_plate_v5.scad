// =========================================================
// GUIDE PLATE V5 — Hex Dampener Plates (Frame-Clamped)
// =========================================================
// Two parallel hex plates below Tier 3.
// Captures angled strings via funnel bushings, constrains to vertical.
//
// Same hex shape as matrix tiers (HEX_R=88.5). No bolt flanges --
...
// =========================================================
module guide_plate_assembly_v5() {
