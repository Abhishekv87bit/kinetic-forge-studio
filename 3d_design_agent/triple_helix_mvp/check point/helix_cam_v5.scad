// =========================================================
// HELIX CAM V5 — Disc-Around-Shaft Eccentric Cam
// =========================================================
...
//   13 unique STLs, number embossed on each disc face.
//
// 13 discs × 27.69°/disc = 360° = one full wave.
...
// VERIFICATION
// =============================================
echo(str("=== HELIX CAM V5 — DISC-AROUND-SHAFT ==="));
