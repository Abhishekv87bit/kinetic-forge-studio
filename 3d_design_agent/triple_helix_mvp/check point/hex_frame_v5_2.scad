// =========================================================
// HEX FRAME V5.2 -- Hexagram Star Frame + Disc-Around-Shaft Cams
// =========================================================
// V5.2 PROTOTYPE: true 75% scale + monolithic matrix, central shaft, 625ZZ bearings.
//
...
module hex_frame_v5(t = 0) {
    ...
    // ---- ECHOES ----
    echo(str("=== HEX FRAME V5.2 -- 75% PROTOTYPE ==="));
