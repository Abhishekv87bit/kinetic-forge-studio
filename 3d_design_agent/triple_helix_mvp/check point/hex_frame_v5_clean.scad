// =========================================================
// HEX FRAME V5 — Clean Frame for 13-Cam Disc-Around-Shaft Design
// =========================================================
// Structural skeleton for the Triple Helix kinetic sculpture.
// Standards: ISO 128 (technical drawing), DFAM (3D print design)
//
// V5 changes:
//   - 13 cams (27.69°/cam) scaled from V4's 9-cam geometry
//   - HEX_R=98 (83% scale), 13 channels at STACK_OFFSET=12mm
//   - Disc-around-shaft eccentric cams on central 5mm steel shaft
//   - 625ZZ frame bearings in carrier plates on arms
//   - V_ANGLE parameter controls arm V-corridor parallelism
//   - Helix extensions via _STAR_RATIO = 2.5
//
// FRAME ARCHITECTURE:
//   Central hex matrix (HEX_R=98) at origin.
//   Hex ring surrounds it.
//   3 STUBS at [0, 120, 240] — clean radial beams.
//   6 HEXAGRAM ARMS forming 3 V-corridors.
...
/* [Hexagram Star — 6 main frame arms — V_ANGLE for parallelism] */
// V_ANGLE = half-angle of V-corridor between arms from same stub
// For 9-cam: 360/9=40°/cam, V_ANGLE=74° works for parallel corridors
// For 13-cam: 360/13≈27.69°/cam, scale V_ANGLE proportionally
// V_ANGLE_13 = 74 × (27.69/40) ≈ 51° for true parallel arms
// START: use V4's 74° to test, then adjust downward for tighter parallelism
V_ANGLE           = 74;    // Start from V4 value, tweak downward to achieve parallelism
ARM_W             = 20;
ARM_H             = 14;
...
// Frame arms PARALLEL (no Z slope) for clean corridor geometry.
// CONVERGE_PCT controls how much: 100 = fully meet at midpoint, 0 = stay parallel.
CONVERGE_PCT      = 0;      // [0:5:100] 0 = perfectly parallel arms for corridors
