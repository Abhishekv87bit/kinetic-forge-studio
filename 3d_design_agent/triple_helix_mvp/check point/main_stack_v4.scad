// =========================================================
// MAIN STACK V4 — Matrix Assembly (Frame-Clamped)
// =========================================================
...
// Open anchor_plate_v4.scad or guide_plate_v4.scad individually
// to see their full detail.
//
// V4 changes:
//   - ALL parameters from config_v4.scad (single source of truth)
//   - matrix_tier_v4.scad for tier rendering
//
...
use <matrix_tier_v4.scad>

$fn = 40;

// =============================================
// COLORS (local to this assembly)
// =============================================
...
// =============================================
// DERIVED (stack height for echo only)
// =============================================
...
// STANDALONE RENDER
// =============================================
main_stack_v4(anim_t());


// =========================================================
// MAIN STACK V4 ASSEMBLY
// =========================================================
module main_stack_v4(t = 0) {
